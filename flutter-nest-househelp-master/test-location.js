...
async function testLocationFunctionality() {
  try {
    ...
    const response1 = await axios.get('http://127.0.0.1:3000/locations/availability?lat=28.615&lng=77.37&radius=5.0');
    ...
    const response2 = await axios.get('http://127.0.0.1:3000/locations/services?lat=28.615&lng=77.37&radius=5.0');
    ...
    const response3 = await axios.get('http://127.0.0.1:3000/locations/zones/nearby?lat=28.615&lng=77.37&maxRadius=2.0');
    ...
    const response4 = await axios.get('http://127.0.0.1:3000/locations/areas?lat=28.615&lng=77.37');
