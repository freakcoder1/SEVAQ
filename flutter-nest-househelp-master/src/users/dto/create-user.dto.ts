import { IsEmail, IsString, IsNotEmpty, IsOptional, IsEnum, IsNumber, MinLength, MaxLength, Matches, ValidateIf, IsIn } from 'class-validator';
...
export class CreateUserDto {
    ...
    @IsOptional()
    @IsEnum(UserRole, { message: 'Role must be one of: user, worker, admin' })
    role?: UserRole;
