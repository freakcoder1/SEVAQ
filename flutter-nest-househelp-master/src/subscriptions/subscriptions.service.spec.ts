...
describe('SubscriptionsService', () => {
  ...
  it('should create a subscription', async () => {
    ...
    jest.spyOn(service, 'createSubscription').mockResolvedValue(mockSubscription as any);
  ...
  it('should get subscriptions by user id', async () => {
    ...
    jest.spyOn(service, 'getSubscriptionsByUserId').mockResolvedValue(mockSubscriptions as any);
  ...
  it('should get active subscriptions', async () => {
    ...
    jest.spyOn(service, 'getActiveSubscriptions').mockResolvedValue(mockSubscriptions as any);
  ...
  it('should get subscription by id', async () => {
    const mockSubscription = { id: 1, userId: 1, serviceProfileId: 1, status: 'ACTIVE' };
    
    jest.spyOn(service, 'getSubscriptionById').mockResolvedValue(mockSubscription as any);
  ...
  it('should pause a subscription', async () => {
    const mockSubscription = { id: 1, userId: 1, serviceProfileId: 1, status: 'PAUSED' };
    
    jest.spyOn(service, 'pauseSubscription').mockResolvedValue(mockSubscription as any);
  ...
  it('should resume a subscription', async () => {
    ...
    jest.spyOn(service, 'resumeSubscription').mockResolvedValue(mockSubscription as any);
  ...
  it('should cancel a subscription', async () => {
    const mockSubscription = { id: 1, userId: 1, serviceProfileId: 1, status: 'CANCELLED' };
    
    jest.spyOn(service, 'cancelSubscription').mockResolvedValue(mockSubscription as any);
