import { IsString, IsNotEmpty, IsNumber, IsOptional, MinLength, MaxLength, IsUrl, Min, Matches } from 'class-validator';
...
export class AdminCreateServiceDto {
    ...
    @Matches(/^[a-zA-Z\s\-&]+$/, { message: 'Service name can only contain letters, spaces, hyphens, and ampersands' })
    name: string;
