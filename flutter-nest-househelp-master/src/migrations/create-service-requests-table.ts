...
export class CreateServiceRequestsTable1736660000004 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        // Create indexes
        await queryRunner.query(`CREATE INDEX "IDX_service_requests_userId_createdAt" ON "service_requests" ("userId", "createdAt")`);
        await queryRunner.query(`CREATE INDEX "IDX_service_requests_assignmentStatus_createdAt" ON "service_requests" ("assignmentStatus", "createdAt")`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        // Drop indexes
        await queryRunner.query(`DROP INDEX "IDX_service_requests_assignmentStatus_createdAt"`);
        await queryRunner.query(`DROP INDEX "IDX_service_requests_userId_createdAt"`);
