// Test login on Railway production server
...
async function main() {
  console.log('Testing Railway production server login...\n');
  
  // Try seeded test user credentials from the seed files
  const credentials = [
    { email: 'test.user1@example.com', password: 'password123' },
    { email: 'test.user2@example.com', password: 'password123' },
    { email: 'test.user3@example.com', password: 'password123' },
