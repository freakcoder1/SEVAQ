...
class LocationProviderV2 with ChangeNotifier {
  ...
  LocationProviderV2() {
    debugPrint('=== LocationProviderV2() constructor called ===');
    _initialize();
  }

  Future<void> _initialize() async {
    try {
      debugPrint('LocationProviderV2: Starting initialization');
      ...
      debugPrint('LocationProviderV2: Initialization completed');
    } catch (e) {
      debugPrint('LocationProviderV2: Initialization error: $e');
      _isLoading = false;
      _isInitialized = true;
      notifyListeners();
    }
  ...
  Future<void> _checkLocationPermission() async {
    try {
      ...
      debugPrint('LocationProviderV2: Permission check error: $e');
  ...
  bool needsLocationSetup() {
    debugPrint('=== LocationProviderV2.needsLocationSetup() called ===');
    debugPrint(
